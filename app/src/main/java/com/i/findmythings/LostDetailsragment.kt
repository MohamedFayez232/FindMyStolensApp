...
import com.i.findmythings.details.ImagesFirebaseRecylerDetailsAdapter
import com.i.findmythings.details.imagesFirebaseRecyclerModel
...
class LostDetailsragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        getPublisherData(lostSerial_Number, publisher_id)
   ...
   private fun getDevicesData(mainchild:String , serailNumber:String){
    ...
    private fun getPublisherData(serialNumber :String , publisher_id:String){
